        ...
        (
            ...
            vertex_shader:
                ...
                @vertex fn vs_main(input: VertexInput) -> VertexOutput {
                    ...
                    let height = textureSample(heightMapTexture_tex, heightMapTexture_samp, heightCoords).r;
                    let finalVertexPosition = vec4f(input.vertexPosition.x, height, input.vertexPosition.z, 1.0);
                    let hx0 = textureSample(heightMapTexture_tex, heightMapTexture_samp, heightCoords + vec2f(-1.0, 0.0) * pixelSize).r;
                    let hx1 = textureSample(heightMapTexture_tex, heightMapTexture_samp, heightCoords + vec2f(1.0, 0.0) * pixelSize).r;
                    let hy0 = textureSample(heightMapTexture_tex, heightMapTexture_samp, heightCoords + vec2f(0.0, -1.0) * pixelSize).r;
                    let hy1 = textureSample(heightMapTexture_tex, heightMapTexture_samp, heightCoords + vec2f(0.0, 1.0) * pixelSize).r;
